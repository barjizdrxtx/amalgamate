...
export default function EditClinics() {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            langtitude_altitude: clinics?.result?.langtitude_altitude,
            ...
            meta_tag: clinics?.result?.meta_tag,
            meta_tag_keyword: clinics?.result?.meta_tag_keyword,
            add_more:'',
            //image: clinics?.result?.clinic_img
        },
