...
import { Box, TextField, Grid, Typography, Select, MenuItem } from '@mui/material';
...
export const EditDoctors = () => {
    ...
    const doctor_id: any = router.query.doc

    const { fetchedData: fetchedData } = useQueryFetchId('doctors', doctor_id)
    ...
    const formik = useFormik({
        initialValues: {
            ...
            specialisedIn: fetchedData?.specialisedIn,
            registration_number: fetchedData?.registration_number,
            email: fetchedData?.email,
            mobile: fetchedData?.mobile,
            years_of_experience: fetchedData?.years_of_experience,
            city: fetchedData?.city,
            state: fetchedData?.state,
            qualificaton: fetchedData?.qualificaton,
            profileText: fetchedData?.profileText,
            consultation_fee: fetchedData?.consultationfee,
        },
        ...
        onSubmit: (values: any) => {
            ...
            axios.patch(`doctors/${doctor_id}`, formData).then((response) => {
            ...
            <Grid container justifyContent="center" xl={12}>
                ...
                <Box>
                    ...
                    <Box>
                        ...
                        <CustomizedButton bgColor="#239B56" onClick={formik.handleSubmit} sx={{ m: 2 }}>Update Doctors</CustomizedButton >
